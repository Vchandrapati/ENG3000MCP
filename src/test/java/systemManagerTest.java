...
//         waitJimmy(System.currentTimeMillis(), 3000);
...
//     @Test
//     void mappingblock() throws Exception {
//         MappingState ms = new MappingState(eb);
//         ms.injectDatabase(db);


//         ms.calculateNextBlock(0, 1);
//         ms.calculateNextBlock(0, -1);

//         ms.calculateNextBlock(11, -1);
//         ms.calculateNextBlock(15, -1);
//         ms.calculateNextBlock(-1, -1);
//     }

//     @Test
//     void mappingblock2() throws Exception {
//         db = new Database();
//         sm.injectDatabase(db);
//         sm.setState(SystemState.MAPPING);
...
//     @Test
//     void mappingblock3() throws Exception {
//         sm.injectDatabase(db);
//         sm.setState(SystemState.MAPPING);
//         sm.run();
...
//         sm.handleTrip(new TripEvent(6, false));
//         sm.run();
//         sm.handleTrip(new TripEvent(6, false));
//         sm.run();
//         sm.handleTrip(new TripEvent(6, false));
...
//     @Test
//     void mappingblock4() throws Exception {
//         sm.setState(SystemState.MAPPING);
//         sm.injectDatabase(db);
//         MappingState.injectDatabase(db);
//         sm.run();
...
//         sm.handleTrip(new TripEvent(1, false));
//         sm.run();

//         sm.handleTrip(new TripEvent(1, true));
//         sm.run();

//         sm.handleTrip(new TripEvent(2, false));
//         sm.run();
        
//         sm.handleTrip(new TripEvent(2, true));
//         sm.run();

//         sm.handleTrip(new TripEvent(3, false));
//         sm.run();

//         sm.handleTrip(new TripEvent(3, true));
//         sm.run();

//         sm.handleTrip(new TripEvent(4, false));
//         sm.run();

//         sm.handleTrip(new TripEvent(4, true));
//         sm.run();

//         sm.handleTrip(new TripEvent(5, false));
//         sm.run();

//         sm.handleTrip(new TripEvent(5, true));
//         sm.run();


//         assertSame(SystemState.RUNNING, sm.currentState);

//     }

//     @Test
//     void waitingOperation10() throws Exception {
//         sm.injectDatabase(db);
...
//         assertSame(SystemState.MAPPING, sm.currentState);
//     }
